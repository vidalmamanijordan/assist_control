    ...
    <div class="p-4 sm:ml-64">
        <div class="grid grid-cols-3 gap-4 mt-14">
            <div class="flex items-center h-12 rounded bg-gray-50 dark:bg-gray-800 col-span-2">
                ...
                <label class="ml-4 font-bold">Información carreras</label>    
            </div>
            <div class="flex items-center justify-center h-12 rounded bg-gray-50 dark:bg-gray-800">
                <a href="{{ route('admincareers.create') }}" class="bg-sky-800 text-white rounded-md px-3 py-2 text-sm font-medium">
                    ...
                    <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                        ...
                        @foreach ($careers as $career)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 custom-truncate">{{ $career->description }}</td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center">
                                        <div class="
                                                ...
                                                "
                                            data-tipe="Editar">
                                            <a href="{{ route('admincareers.edit', $career) }}" class="text-sky-400">
                                        ...
                                        <div class="
                                                ...
                                                "
                                            data-tipe="Eliminar">
                                            <form action="{{ route('admincareers.destroy', $career) }}" method="POST" class="formulario-eliminar">
                                                @csrf
                                                @method('delete')
...
@section('js')
    ...
    @if (Session('message') == 'El registro ha sido eliminado satisfactoriamente')
        <script>
            Swal.fire(
                    '¡Eliminado!',
                    'La carrera profesional se eliminado con éxito.',
                    'success'
                    )
        </script>
    @endif
    <script>
        $('.formulario-eliminar').submit(function(e){ /* Capturo el evento en e */
            ...
            Swal.fire({
                title: '¿Estás seguro?',
                text: "¡Esta carrera profesional se eliminará definitivamente!",
                icon: 'warning',
