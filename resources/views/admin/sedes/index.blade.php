    ...
    <div class="p-4 sm:ml-64">
        <div class="grid grid-cols-3 gap-4 mt-14">
            <div class="flex items-center h-12 rounded bg-gray-50 dark:bg-gray-800 col-span-2">
                ...
                <label class="ml-4 font-bold">Información sedes</label>    
            </div>
            <div class="flex items-center justify-center h-12 rounded bg-gray-50 dark:bg-gray-800">
                <a href="{{ route('adminsedes.create') }}" class="bg-sky-800 text-white rounded-md px-3 py-2 text-sm font-medium">
                    ...
                    <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                        ...
                        @foreach ($sedes as $sede)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">{{ $sede->description }}</td>
                                <td class="px-6 py-4">
                                    <span
...
@section('js')
    ...
    @if (Session('message') == 'La sede ha sido eliminado satisfactoriamente')
        <script>
            Swal.fire(
                    '¡Eliminado!',
