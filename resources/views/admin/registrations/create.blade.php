...
@section('work_area')
    <div
        ...
        <h5 class="mb-10 text-3xl font-bold text-gray-900 dark:text-white">Evento: {{ $eventName->name }}</h5>
        ...
        <div class="mt-4 flex justify-center">
            <div class="p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
                role="alert">
                <span class="text-3xl font-bold">Hora: </span><label class="text-3xl font-medium" id="hora-actual"></label>
            </div>
        </div>
        <script>
