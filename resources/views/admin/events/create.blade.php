    ...
    <div class="p-4 sm:ml-64">
        <div class="grid grid-cols-3 gap-4 mt-14">
            <div class="flex items-center h-12 rounded bg-gray-50 dark:bg-gray-800 col-span-2">
                ...
                <label class="ml-4 font-bold">Nuevo evento</label>
            </div>
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-2">
            ...
            <div class="grid mb-6">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div class="mt-6">
                        {!! Form::label('start_date', 'Fecha y Hora Inicio del Evento:', [
                            'class' => 'text-left block mb-2 text-sm font-medium text-gray-900 dark:text-white',
                        ]) !!}
                        {!! Form::input('datetime-local', 'start_date', null, [
                            'class' =>
                                'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500',
                            'required' => 'required',
                        ]) !!}
                    ...
                    <div class="mt-6">
                        {!! Form::label('end_date', 'Fecha y Hora Termino del Evento:', [
                            'class' => 'text-left block mb-2 text-sm font-medium text-gray-900 dark:text-white',
                        ]) !!}
                        {!! Form::input('datetime-local', 'end_date', null, [
                            'class' =>
                                'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500',
                            'required' => 'required',
                        ]) !!}
