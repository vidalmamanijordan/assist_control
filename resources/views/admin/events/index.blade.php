...
@section('work_area')
    {{-- <div
        ...
        <div class="flex items-center justify-center">
            ...
            <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Información Eventos</h5>
            <div class="ml-auto">
    ...
    <div class="p-4 sm:ml-64">
        <div class="grid grid-cols-3 gap-4 mt-14">
            ...
            <div class="flex items-center justify-center h-12 rounded bg-gray-50 dark:bg-gray-800">
                <a href="{{ route('adminevents.create') }}" class="bg-sky-800 text-white rounded-md px-3 py-2 text-sm font-medium">
