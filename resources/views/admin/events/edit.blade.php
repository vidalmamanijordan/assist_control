...
@section('work_area')
    {{-- <div class="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 col-span-4">
        <div class="flex items-center justify-center">
            ...
            <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Editar Evento: <label class="text-gray-500 font-light">{{ $event->name }}</label></h5>
            <div class="ml-auto">
        ...
        <hr class="mb-6 mt-6">
        {!! Form::model($event, ['route' => ['adminevents.update', $event], 'method' => 'put']) !!}
            <div class="grid mb-6">
                <div>
            ...
            {!! Form::submit('Actualizar evento', ['class' => 'cursor-pointer mb-6 float-right text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 mr-2', 'required' => 'required']) !!}
        {!! Form::close() !!}
    </div> --}}
    ...
    <div class="p-4 sm:ml-64">
        <div class="grid grid-cols-3 gap-4 mt-14">
            <div class="flex items-center h-12 rounded bg-gray-50 dark:bg-gray-800 col-span-2">
                ...
                <label class="ml-4 font-bold">Evento:</label>&nbsp;<label class="text-gray-500">{{ $event->name }}</label>
            </div>
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-2">
            ...
            {!! Form::submit('Actualizar evento', ['class' => 'cursor-pointer mb-6 float-right bg-sky-800 text-white rounded-md px-3 py-2 text-sm font-medium', 'required' => 'required']) !!}
        {!! Form::close() !!}
        </div>
    </div>
@endsection