    ...
    {{-- <div class="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 col-span-4">
        <div class="flex items-center justify-center">
            <span class="mr-5 text_midnight_blue">
                <i class="fa-solid fa-tents text-4xl"></i>
            </span>
            <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Nueva Facultad</h5>
            <div class="ml-auto">
        ...
        <hr class="mt-6 mb-6">
        {!! Form::open(['route' => 'adminfaculties.store', 'autocomplete' => 'off']) !!}
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    {!! Form::label('name', 'Facultad', ['class' => 'text-left block mb-2 text-sm font-medium text-gray-900 dark:text-white']) !!}
                ...
                <div>
                    {!! Form::label('sede_id', 'Elija Sede', ['class' => 'text-left block mb-2 text-sm font-medium text-gray-900 dark:text-white']) !!}
            ...
            {!! Form::submit('Crear facultad', ['class' => 'cursor-pointer mb-6 float-right text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 mr-2']) !!}
        {!! Form::close() !!}
    </div> --}}
    ...
    <div class="p-4 sm:ml-64">
        <div class="grid grid-cols-3 gap-4 mt-14">
            <div class="flex items-center h-12 rounded bg-gray-50 dark:bg-gray-800 col-span-2">
                ...
                <label class="ml-4 font-bold">Nueva facultad</label>
            </div>
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-2">
            ...
            {!! Form::submit('Crear facultad', ['class' => 'cursor-pointer mb-6 float-right bg-sky-800 text-white rounded-md px-3 py-2 text-sm font-medium']) !!}
        {!! Form::close() !!}
        </div>
    </div>
@endsection
