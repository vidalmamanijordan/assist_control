<div
    ...
    <form class="flex items-center">
        ...
        <button type="submit"
            class="p-2.5 ms-2 text-sm font-medium text-white bg-rose-700 rounded-lg border border-rose-700 hover:bg-rose-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Limpiar
        </button>
    </form><br>
