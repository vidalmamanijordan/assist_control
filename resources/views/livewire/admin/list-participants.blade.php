                ...
                <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 font-medium text-gray-900 text-center">Ciclo</th>
                            <th scope="col" class="px-6 py-4 font-medium text-gray-900 text-center">Grupo</th>
                    ...
                    <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                        ...
                        @foreach ($participants as $participant)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">{{ $participant->dni }}</td>
                                <td class="px-6 py-4">{{ $participant->code }}</td>
                                <td class="px-6 py-4">{{ $participant->phone }}</td>
                                <td class="px-6 py-4">{{ $participant->email }}</td>
                                <td class="px-6 py-4">{{ $participant->career->name }}</td>
                                <td class="px-6 py-4 text-center">{{ $participant->semester }}</td>
                                <td class="px-6 py-4 text-center">{{ $participant->group }}</td>
                                <td class="px-6 py-4">
                                    <span
