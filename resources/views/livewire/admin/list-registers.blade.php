...
<div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 col-span-4">
    ...
    <div class="bg-white rounded p-8 shadow mb-6">
        ...
        <div class="flex space-x-4 mb-4">
            <div>
                Evento:
                <select wire:model="filters.event_id" name="event" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
            ...
            <div>
                Carrera:
                <select wire:model="filters.career" name="" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                    <option value="">Todos</option>
            ...
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Usuario <label class="text-sm font-thin">(registrador)</label></th>
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    @foreach ($assits as $assit)
                        <tr class="hover:bg-gray-50">
                            ...
                            {{-- <td class="px-6 py-4">{{ $assit->participant->career->name }}</td> --}}
